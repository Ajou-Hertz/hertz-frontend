    ...
    <div>
      ...
      <div style={{ border: '1px solid black', margin: '0 50px 50px 50px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', flex: '0 0 30%',
            ...
            <button onClick={toggleFastResponse} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              응대가 빨라요
              {fastResponse ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleSoundproofing} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              방음이 잘돼요
              {soundproofing ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleRevisit} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              다음에 또 이용하고 싶어요
              {revisit ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleContentMatch} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              글의 내용과 일치해요
              {contentMatch ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleGoodParking} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              주차장이 편리해요
              {goodParking ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleGoodfacility} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              시설이 좋아요
              {goodfacility ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleKindlyReply} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              질문에 친절하게 답해줘요
              {kindlyReply ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleGoodEquipment} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              장비 관리가 잘되어 있어요
              {goodEquipment ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleCleanliness} 
              style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              공간이 청결해요
              {cleanliness ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
            <button onClick={toggleWide} style={{ margin: '15px 20px', padding: '10px', width: '400px', 
              backgroundColor: '#D6E0F3', fontSize: '18px', borderRadius: '5px', border: 'none', cursor: 'pointer' }}>
              공간이 넓어요
              {wide ? <RiCheckboxCircleFill  color="red" /> : <RiCheckboxCircleFill color="white" />}
            </button>
        </div>
