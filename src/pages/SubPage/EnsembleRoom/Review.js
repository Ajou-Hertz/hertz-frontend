    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <div style={{ border: '1px solid black', height: '600px', overflowY: 'auto' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', margin: '10px 20px' }}>
                    ...
                    <button style={{ backgroundColor: '#637DBE', border: 'none', color: 'white',
                        borderRadius: '10px', padding: '5px 20px', marginTop: '5px', height: '45px' }}
        ...
        <div style={{ width: '70%', marginRight: '50px', marginLeft: '40px', marginBottom: '50px' }}>
            {/* text */}
            <div style={{ border: '1px solid black', height: '600px', overflowY: 'auto' }}>
                <p style={{ margin: '20px 30px', textAlign: 'left', fontWeight: 'bold', fontSize: '22px' }}
                >Text</p>
                {/* 텍스트 리뷰들 */}
                <div style={{ border: '1px solid black', minHeight: '150px', margin: '30px' }}>
                    <div style={{ textAlign: 'left', margin: '10px' }}>
                      <p value={userID}
                        style={{ display: 'inline', marginLeft: '20px' }}>qwe****</p>
                      <p style={{ display: 'inline', marginLeft: '50px' }}>2024.02.05</p>
                      <p style={{ margin: '20px 50px' }}>최대 7명이라고 했는데 7명이선 좀 좁았어요. 6명이 적당해보여요.</p>
                      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 'auto' }}>
                        <button onClick={handleHelpfulButtonClick}
                            style={{ 
                              display: 'flex', 
                              alignItems: 'center', 
                              justifyContent: 'center', 
                              backgroundColor: '#637DBE', 
                              border: helpfulButtonClicked ? '3px solid #D6E0F3' : '3px solid white', // 조건부 스타일 적용
                              borderRadius: '10px', 
                              margin: '0px', 
                            ...
                            도움이 되었어요
                            {helpfulButtonClicked ? <FaThumbsUp style={{ marginLeft: '4px' }} /> : <FaRegThumbsUp style={{ marginLeft: '4px' }} />}
                        </button>
                      </div>
                    </div>
                </div>
