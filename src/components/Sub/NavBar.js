      ...
      <Navbar key={expand} expand={expand} className="bg-white mb-3">
        <Container fluid>  
            <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '100px', paddingLeft: '20px' }} navbarScroll>
              <Nav.Link style={{color: (location.pathname === '/InstrumentList' || location.pathname.startsWith('/InstrumentDetail')) ? '#637DBE' : 'black', fontWeight: (location.pathname === '/InstrumentList' || location.pathname.startsWith('/InstrumentDetail')) ? 'bold' : 'normal'}} href="/InstrumentList">중고악기</Nav.Link>
