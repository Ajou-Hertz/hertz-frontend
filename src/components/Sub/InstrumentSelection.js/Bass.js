            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <option value="SPECTOR">Spector(Mexico)</option>
                        <option value="MUSIC_MAN">MusicMan</option>
                        <option value="SCHETOR">Schetor</option>
                ...
                >
                    ...
                    >
                        ...
                        <option value="PRECISION">프레시젼</option>
                        <option value="PJ">PJ</option>
                        <option value="HUMBUCKER">험버커</option>
                        <option value="ETC">그 외</option>
                    </select>
                </div>
                {/* 프리앰프 드롭다운 */}
                ...
                >
                    <select
                        style={{ height: "40px", borderRadius: "3px" }}
                        onChange={(event) =>
                            setSelectedPreAmplifier(event.target.value)
                        }
                    >
                        <option value="ACTIVE">액티브</option>
                        <option value="PASSIVE">패시브</option>
                        <option value="SWITCHABLE">전환 가능</option>
                    </select>
                </div>
                {/* 색상 드롭다운 */}
                <div
