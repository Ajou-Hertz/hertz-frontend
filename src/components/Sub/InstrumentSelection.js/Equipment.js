...
const Equipment = ({ updateEquipmentData }) => {
    ...
    const [selectedType, setSelectedType] = useState("AUDIO_EQUIPMENT"); // 종류 상태
    ...
    useEffect(() => {
        updateData();
    }, [selectedState, selectedType, price, selectedFeature, hashtags]);
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            >
                ...
                >
                    ...
                    >
                        <option value="AUDIO_EQUIPMENT">음향장비</option>
