        ...
        <div>
          ...
          <div style={modalStyle}>
            ...
            <div style={{ textAlign: 'left' }}>
                <p style={{ fontSize: '25px', fontWeight: 'bold' }}>개인정보처리방침</p>
                <p>제 1조 (목적)</p>
                <p>
                    Hertz(헤르츠)(이하 ‘회사’라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 ‘정보통신망법’)등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
                </p>
                ...
                <p>    
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 회사가 운영하는 인터넷 홈페이지의 첫 화면의 공지사항란 또는 별도의 창을 통하여 공지하는 방법</div>
                    <div style={{ textIndent: '20px' }} >나. 서면,모사전송,전자우편 또는 이와 비슷한 방법으로 이용자에게 공지하는 방법 </div>
                ...
                <p>
                    ...
                    1. 필수 수집 정보 : 이메일 주소, 비밀번호 및 휴대폰 번호
                </p>
                ...
                <p>제 10조 (법령에 따른 개인정보의 보유 및 이용기간)</p>
                <p>    
                    회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다. <br/>
                    1. 전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보 및 보유기간 <br/>
                    <div style={{ textIndent: '20px' }}>가. 계약 또는 청약철회 등에 관한 기록 : 5년 </div>
                    <div style={{ textIndent: '20px' }}>나. 대금결제 및 재화 등의 공급에 관한 기록 : 5년 </div>
                    <div style={{ textIndent: '20px' }}>다. 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 </div>
                    <div style={{ textIndent: '20px' }}>라. 표시, 광고에 관한 기록 : 6개월 </div>
                    2. 통신비밀보호법에 따른 보유정보 및 보유기간 <br/>
                    <div style={{ textIndent: '20px' }}>가. 웹사이트 로그 기록 자료 : 3개월 </div>
                    3. 전자금융거래법에 따른 보유정보 및 보유기간 <br/>
                    <div style={{ textIndent: '20px' }}>가. 전자금융거래에 관한 기록 : 5년 </div>
                    4. 위치정보의 보호 및 이용 등에 관한 법률 <br/>
                    <div style={{ textIndent: '20px' }}>가. 개인위치정보에 관한 기록 : 6개월 </div> 
                </p>
                ...
                <p>
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우, 거래가 종료된 날로부터 6개월 이내에 회사가 처리하고 수신자와 거래한 것과 동종의 재화 등에 대한 영리목적의 광고성 정보를 전송하려는 경우 </div>
                    <div style={{ textIndent: '20px' }}> 나. [방문판매 등에 관한 법률]에 따른 전화권유판매자가 육성으로 수신자에게 개인정보의 수집출처를 고지하고 전화권유를 하는 경우 </div>
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 회사명 및 연락처 </div>
                    <div style={{ textIndent: '20px' }}> 나. 수신 거부 또는 수신 동의의 철회 의사표시에 관한 사항의 표시 </div>
                    5. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음 각 호의 어느 하나에 해당하는 조치를 하지 않습니다.
                    <div style={{ textIndent: '20px' }}> 가. 광고성 정보 수신자의 수신거부 또는 수신동의의 철회를 회피,방해하는 조치 </div>
                    <div style={{ textIndent: '20px' }}> 나. 숫자,부호 또는 문자를 조합하여 전화번호, 전자우편주소 등 수신자의 연락처를 자동으로 만들어 내는 조치 </div>
                    <div style={{ textIndent: '20px' }}> 다. 영리목적의 광고성 정보를 전송할 목적으로 전화번호 또는 전자우편주소를 자동으로 등록하는 조치 </div>
                    <div style={{ textIndent: '20px' }}> 라. 광고성 정보 전송자의 신원이나 광고 전송 출처를 감추기 위한 각종 조치 </div>
                    <div style={{ textIndent: '20px' }}> 마. 영리목적의 광고성 정보를 전송할 목적으로 수신자를 기망하여 회신을 유도하는 각종 조치 </div>
                </p>
                <p>제15조 (개인정보 조회 및 수집동의 철회)</p>
                <p>
                    1. 이용자 및 법정 대리인은 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 개인 정보수집 등의 철회를 요청할 수 있습니다. <br/>
                ...
                <p>
                    1. 이용자는 회사에게 전조의 방법을 통해 개인정보의 오류에 대한 정정을 요청할 수 있습니다. <br/>
                ...
                <p>
                    회사는 개인정보의 분실,도난,유출(이하 “유출 등”이라 한다) 사실을 안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다. <br/>
                    1. 유출 등이 된 개인정보 항목 <br/>
                    2. 유출 등이 발생한 시점 <br/>
                    3. 이용자가 취할 수 있는 조치 <br/>
                    4. 정보통신서비스 제공자 등의 대응 조치 <br/>
                    5. 이용자가 상담 등을 접수할 수 있는 부서 및 연락처 <br/>
                </p>
                ...
                <p>제 20조 (개인정보 자동 수집 장치의 설치,운영 및 거부에 관한 사항)</p>
                <p>
                ...
                <p>
                    ...
                    2. Chrome : 웹브라우저 우측 상단의 설정 메뉴 > 개인정보 및 보안 > 쿠키 및 사이트 데이터 <br/>
                ...
                <p>
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 개인정보 보호 책임자 </div>
                    <div style={{ textIndent: '40px' }}> 1. 성명 : 윤지현 </div>
                    <div style={{ textIndent: '40px' }}> 2. 직책 : CEO </div>
                    <div style={{ textIndent: '40px' }}> 3. 전화번호 : 070-8983-7648 </div>
                    <div style={{ textIndent: '40px' }}> 4. 이메일 : hertzajou@gmail.com </div>
                </p>
                ...
                <p>
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 개인정보분쟁조정위원회 : (국번없이) 1833-6972 (www.kopico.go.kr) </div>
                    <div style={{ textIndent: '20px' }}> 나. 개인정보침해신고센터 : (국번없이) 118 (privacy.kisa.or.kr) </div>
                    <div style={{ textIndent: '20px' }}> 다. 대검찰청 : (국번없이) 1301 (www.spo.go.kr) </div>
                    <div style={{ textIndent: '20px' }}> 라. 경찰청 : (국번없이) 182 (ecrm.cyber.go.kr) </div>
                    ...
                    <div style={{ textIndent: '20px' }}> 가. 중앙행정심판위원회 : (국번없이) 110 (www.simpan.go.kr) </div>
                </p>
                <p>
                    부칙 <br/>
                    제1조 본 방침은 2024.03.14부터 시행됩니다.</p>
            </div>
